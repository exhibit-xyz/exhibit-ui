          ...
          <section>
            ...
            >
              ...
              <div className='flex gap-4'>
                {cooldown === null ? (
                  <button className='flex-1 rounded-md mt-1 h-12 bg-blue-500'>
                    Bid
                  </button>
                ) : (
                  <button
                    className='flex-1 rounded-md mt-1 h-12 dark:bg-gray-800 dark:text-gray-400'
                    disabled
                  >
                ...
                <button
                  className='flex-1 rounded-md mt-1 h-12 bg-orange-500'
                  type='button'
                >
                  Settle
                </button>
